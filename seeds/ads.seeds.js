...
const ads = [
    {
        ...
        condition: 'Like New',
        status: 'Available',
        owner: '6319f5f781b97a1ae8c94075',
        city: 'Paris',
    ...
    {
        title: 'Comfy onesie',
        description: 'Doe pajama jumpsuit. Very warm and comfy with fleece on the inside',
        brand: 'Etam',
        size: 'M',
        category: 'Pyjamas',
        condition: 'Good Condition',
    ...
    {
        title: 'Summer shorts',
        description: 'Mustard color, elastic waist and knot to tie. Never worn, still tagged.',
        brand: 'Etam',
        size: 'L',
        category: 'Shorts',
        condition: 'Brand New',
